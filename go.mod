...
require (
	...
	github.com/tidepool-org/clinic/client v0.0.0-20260304153151-be04f2280a4f
	github.com/tidepool-org/clinic/redox_models v0.0.0-20260304153151-be04f2280a4f
